...
class LimbRiggerWidget(QWidget):
    def __init__(self):
        ...
        ctrlSizeLayout.addWidget(QLabel("ControllerSize: "))
    ...
    def BuildRig(self):
        ...
        ikEndCtrlName, ikEndCtrlGrpName, poleVectorCtrlName, poleVectorCtrlGrpName, ikHanleName = self.BuildIkControls(rootJnt, midJnt, endJnt)
    ...
    def BuildIkControls(self, rootJnt, midJnt, endJnt):
        ...
        poleVectorCtrlName = "ac_ik" + midJnt
        ...
        mc.parent(ikHanleName, endCtrlName)
